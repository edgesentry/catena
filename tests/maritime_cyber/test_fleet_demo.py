...
from pipeline.maritime_cyber.fleet_demo import (
...
from pipeline.maritime_cyber.rules import validate_asset_map
...
def test_fleet_log4j_affected_subset() -> None:
    from pipeline.maritime_cyber.eval import affected_vessels
